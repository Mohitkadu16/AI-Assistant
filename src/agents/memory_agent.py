...
class MemoryAgent(BaseAgent):
    """
    Responsibilities:
    * Search project knowledge, Retrieve documents
    * Retrieve previous notes, Provide context to other agents
    * Connect to future vector database
    """
    def __init__(self) -> None:
        super().__init__(name="Memory Agent", description="Knowledge retrieval and context generation.")
        self.system_prompt = PromptLoader.get_prompt("memory")
