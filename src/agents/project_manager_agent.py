...
class ProjectManagerAgent(BaseAgent):
    """
    Responsibilities:
    * Organize tasks, Roadmaps, Milestones
    * Progress tracking, Prioritization, Daily planning
    """
    def __init__(self) -> None:
        super().__init__(name="Project Manager Agent", description="Project management and task tracking.")
        self.system_prompt = PromptLoader.get_prompt("pm")
