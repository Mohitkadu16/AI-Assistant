...
class StudKitsBusinessAgent(BaseAgent):
    """
    Responsibilities:
    * Startup planning, Marketing, Product descriptions
    * Documentation, Landing pages, Email drafts, Business strategy
    """
    def __init__(self) -> None:
        super().__init__(name="StudKits Business Agent", description="Startup and business strategy assistant.")
        self.system_prompt = PromptLoader.get_prompt("business")
