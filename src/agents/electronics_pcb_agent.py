...
class ElectronicsPCBAgent(BaseAgent):
    """
    Responsibilities:
    * KiCad, PCB review, Schematic review
    * Datasheet understanding, Component selection, BOM generation
    * Embedded systems
    Preferred Model: Ollama (Qwen)
    """
    def __init__(self) -> None:
        super().__init__(name="Electronics & PCB Agent", description="Hardware and electronics design assistant.")
        self.system_prompt = PromptLoader.get_prompt("electronics")
